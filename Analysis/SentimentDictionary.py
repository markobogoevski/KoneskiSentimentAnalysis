        ...
        with open(vad_path, 'r', encoding='utf-8') as vad_file:
            ...
            for _, row in emotion_df.iterrows():
                ...
                for emotion in emotions:
                    if word_emotion_dictionary['eng'][eng_word]['emotional_intensity'][emotion] == -1:
                    ...
                    if mk_word != 'no translation':
                        if word_emotion_dictionary['mk'][mk_word]['emotional_intensity'][emotion] == -1:
                            word_emotion_dictionary['mk'][mk_word]['emotional_intensity'][emotion] = emotion_vector[idx]
                    if word_emotion_dictionary['eng'][eng_word]['emotional_intensity'][emotion] > 0:
                        neutral = 0
                    idx += 1
            ...
            # dictionary_file = open("dictionary_lemma.pkl", "wb")
